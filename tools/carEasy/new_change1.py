...
def elitism_selection(population, fitness_values, num_elites):
    ...
    while len(new_population) < 20:
        ...
        if random_index not in elite_indices:
...
def main():
    ...
    for txt_file in txt_files:
        ...
        for i in range(max_iterations):
            ...
            # 精英加锦标赛选择操作
            # selected_population ,_,_,_,_,_,_= elitism_tournament_selection(new_population, fitness, num_elites,
            #                                                    tournament_size)
        ...
        with open(output_file, "w") as file:
            ...
            if (best_all_label != 1 or best_all_label<0.5):
                false_pred+=1
                print("攻击成功")
                # 恢复标准输出到控制台
