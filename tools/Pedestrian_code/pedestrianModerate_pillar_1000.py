...
folder_path1 = "../input_data输入/八个顶点/Pedestrian/Moderate"
folder_path2="../input_data输入/提取的点云/Pedestrian/Moderate"
# 获取文件夹中所有文件的文件名列表
...
def parse_config(file_number):
    ...
    parser.add_argument('--per_data_path', type=str, default=os.path.join("/home/Newdisk/liaodanxin/pcdet111/OpenPCDet/tools/final_result结果/中间bin/pointpillar/1000/20个扰动点/Pedestrian/Moderate", f"{file_number}.bin"),
                        help='specify the point cloud data file or directory')
...
def attack_GA1(points,perturbations,args,cfg,logger,first_pred_boxes,file_number):
    ...
    with open(os.path.join("/home/Newdisk/liaodanxin/pcdet111/OpenPCDet/tools/final_result结果/中间bin/pointpillar/1000/20个扰动点/Pedestrian/Moderate", f"{file_number}.bin"), 'wb') as f:
...
def main():
    ...
    for txt_file in txt_files:
        ...
        passPath = "/home/Newdisk/liaodanxin/pcdet111/OpenPCDet/tools/final_result结果/最优扰动点/pointpillar/1000/20个扰动点/Pedestrian/Moderate"
        # 获取文件夹中所有文件的文件名列表
        ...
        output_file=os.path.join("/home/Newdisk/liaodanxin/pcdet111/OpenPCDet/tools/final_result结果/输出控制台结果/pointpillar/1000/20个扰动点/Pedestrian/Moderate", txt_file)
        number_bin += 1
        ...
        best_individual_file=os.path.join("/home/Newdisk/liaodanxin/pcdet111/OpenPCDet/tools/final_result结果/最优扰动点/pointpillar/1000/20个扰动点/Pedestrian/Moderate", txt_file)
        np.savetxt(best_individual_file, best_individual)
        max_fitness_file=os.path.join("/home/Newdisk/liaodanxin/pcdet111/OpenPCDet/tools/final_result结果/每一次迭代最大适应度值绘制/pointpillar/1000/20个扰动点/Pedestrian/Moderate", txt_file)
        ...
        plt.xlabel('iter_num')
        plt.legend()
        plt.savefig(os.path.join("/home/Newdisk/liaodanxin/pcdet111/OpenPCDet/tools/final_result结果/每一次迭代最大适应度值绘制/pointpillar/1000/20个扰动点/Pedestrian/Moderate", f"{file_number}.jpg"))
        print(file_number)
        if(number_bin==100):
            break
